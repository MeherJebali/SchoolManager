<%@ Page Language="C#" MasterPageFile="~/Administrateur/Admin.Master" AutoEventWireup="true" CodeBehind="Enseignants.aspx.cs" Inherits="Suivi.Administrateur.WebForm3" Title="Page sans titre" %>
     ...
     <asp:DataList ID="DataList1" runat="server" RepeatColumns="4" HorizontalAlign="Center" BorderColor="#14327B">
        <ItemTemplate>
            <table border="2" rules=none BorderColor="#808080">
                <tr>
                    <td colspan="2">
                        <asp:Image ID="photo" runat="server" ImageURL='<%# Eval("Photo_ens") %>'  Width="200px" Height="150px" />
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                         <asp:Label ID="lblNom" runat="server" Text='<%# Eval("Prenom_ens") %>' Font-Bold="True"></asp:Label>
                         <asp:Label ID="lblPrenom" runat="server" Text='<%# Eval("Nom_ens") %>' Font-Bold="True"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblEmail" runat="server" Text='<%# Eval("Email_ens") %>' Font-Bold="True"></asp:Label>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <asp:Label ID="lblTel" runat="server" Text='<%# Eval("Tel_ens") %>' Font-Bold="True"></asp:Label>
                    </td>
                </tr>
            </table>
        </ItemTemplate>
