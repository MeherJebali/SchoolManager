<%@ Page Language="C#" MasterPageFile="~/Administrateur/Admin.Master" AutoEventWireup="true" CodeBehind="Eleves_Ajout.aspx.cs" Inherits="Suivi.Administrateur.WebForm17" Title="Page sans titre" %>
...
<div class="profs">
    ...
    <tr align=center><td colspan="2" style="color:White;background-color:#5D7B9D;font-weight:bold;">Ajouter un élève</td></tr>
    <tr>
        <td align=right><b>Parent : </b></td>
        <td>
            <asp:TextBox ID="txtParent" runat="server" MaxLength="8"></asp:TextBox>
            <asp:RequiredFieldValidator ID="reqCin" runat="server" ErrorMessage="obligatoire" ControlToValidate="txtParent" ToolTip="Le CIN du parent est Requis">*</asp:RequiredFieldValidator>
            <asp:CompareValidator ID="comCin" runat="server" ErrorMessage="Le Numéro de Téléphone doit être composé de 8 chiffres." ControlToValidate="txtParent" Type="Integer" Operator="DataTypeCheck" ToolTip="Le Numéro de Téléphone doit être composé de 8 chiffres.">*</asp:CompareValidator>
    ...
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="req1" runat="server" ErrorMessage="obligatoire" ControlToValidate="txtPrenom" ToolTip="Le Prénom de l'élève est Requis">*</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="req2" runat="server" ErrorMessage="obligatoire" ControlToValidate="txtNom" ToolTip="Le nom de l'élève est requis">*</asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="req3" runat="server" ErrorMessage="obligatoire" ControlToValidate="txtDate" ToolTip="La date de naissance est requise">*</asp:RequiredFieldValidator>
            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="CompareValidator" ControlToValidate="txtDate" Type=Date Operator=DataTypeCheck ToolTip="Vérifier le format de la date">*</asp:CompareValidator>
        </td>
    </tr>
    <tr>
        <td align=right><b>Sexe : </b></td>
        <td>
            <asp:RadioButtonList ID="rbSexe" runat="server">
            <asp:ListItem Selected="True" Value="F">Fille</asp:ListItem>
            <asp:ListItem Value="M">Garçon</asp:ListItem>
            </asp:RadioButtonList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <br /><br />
            <asp:LinkButton ID="AddParent" runat="server" Text="" Visible="False" 
                onclick="AddParent_Click" ForeColor=Red></asp:LinkButton>
                <ASPP:PopupPanel HeaderText="Ajouter un parent" ID="pup" runat="server" BackColor=Red>
                ...
                <ContentTemplate>
                    <table border="0" style="font-family:Verdana;font-size:100%;">
                        ...
                        <tr>
                            ...
                            <td>
                                <asp:TextBox ID="txtCin" runat="server" MaxLength="8" Enabled="false"></asp:TextBox>
                        ...
                        <tr align="right">
                            <td align="right" colspan="0">
                                <asp:Button ID="StepNextButton" runat="server" BackColor="#FFFBFF" 
                                    ...
                                    Text="Créer un parent" ValidationGroup="CreateUserWizard1" />
                            </td>
                        </tr>
                    </table>
                </CustomNavigationTemplate>
    ...
    <tr>
        <td colspan="2" align="center">
        <br /><br />
            <asp:Button ID="btnAdd" runat="server" Text="Ajouter un élève" 
