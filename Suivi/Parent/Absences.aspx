<%@ Page Title="" Language="C#" MasterPageFile="~/Parent/Parent.Master" AutoEventWireup="true" CodeBehind="Absences.aspx.cs" Inherits="Suivi.Parent.WebForm11" %>
...
<div class="profs">
        ...
        <asp:DataList ID="DLEleve" runat="server" RepeatColumns="4" 
            ...
            <ItemTemplate>
                    ...
                    <tr>
                        <td>
                            <a href="Absences_Details.aspx?ID_eleve=<%# Eval("ID_eleve") %>">Voir Détails</a>
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
