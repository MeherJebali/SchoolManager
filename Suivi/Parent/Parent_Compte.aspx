<%@ Page Language="C#" MasterPageFile="~/Parent/Parent.Master" AutoEventWireup="true" CodeBehind="Parent_Compte.aspx.cs" Inherits="Suivi.Parent.WebForm2" Title="Page sans titre" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="test" runat="server">
    ...
    <ItemTemplate>
        <ItemTemplate>
                ...
                <br />
                <asp:Image ID="Image1" runat="server" ImageURL='<%# Eval("Photo_parent") %>'                                  Width="320px" Height="220px" />
                <br />
                <br />
                <font color="#f3961b"><b>Nom d'utilisateur :</b></font>
                <asp:Label ID="descriptionLabel" runat="server" 
                    Text='<%# Eval("Username_parent") %>' />
                <br />
                <br />
                <font color="#f3961b"><b>Numéro de CIN :</b></font>
                <asp:Label ID="prixLabel" runat="server" Text='<%# Eval("CIN_parent") %> ' />
                <br />
                <br /> 
                <font color="#f3961b"><b>Numéro de Téléphone : </b></font>
                <asp:Label ID="formatDate" runat="server" Text='<%# Eval("Tel_parent") %>'></asp:Label>
                <br />
                <br />
                <font color="#f3961b"><b>Adresse Email : </b></font>
                
                <asp:Label ID="nbrPlacesLabel" runat="server" Text='<%# Eval("Email_parent") %>' />              
            </ItemTemplate>
    </ItemTemplate>
    </asp:DataList>
    <br />
